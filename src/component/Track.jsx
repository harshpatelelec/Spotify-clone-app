...
function Track(props) {
  ...
  const trackIcon =(url) =>{
    if(!url) return <strong className='text-danger'>No Track</strong>;

    if(playing && url === preUrl) return <button className="btn btn-sm btn-warning"> <i className='bi bi-pause-fill'></i>Pause</button>
    return <button className="btn btn-sm btn-success"> <i className='bi bi-play-fill'>Play</i> </button>
  }

  // to convert miliseconds to time (min:sec)
